...
function FormBudget({
  ...
  const onSubmit = (data) => {
    setFormData({ ...formData, budgetChoice: data.choice });
            ...
            <div className="w-full flex flex-col items-center">
              <div className="bg-white shadow-md rounded mb-4 w-full sm:w-full  lg:w-3/5">
                <label className="block text-center py-4 flex justify-start items-center">
                  ...
                  />
                  <span className="text-lg align-middle w-full">Under $400 / Month</span>
                </label>
              </div>
              ...
              <div className="bg-white shadow-md rounded mb-4 w-full sm:w-full  lg:w-3/5">
                <label className="block text-center py-4 flex justify-start items-center">
                  <input
                    ...
                    className="form-radio h-5 w-5 text-blue-600 inline-block ml-3"
                  />
                  <span className="text-lg align-middle w-full">$400-499 / Month</span>
                </label>
              </div>
              ...
              <div className="bg-white shadow-md rounded mb-4 w-full sm:w-full lg:w-3/5">
                <label className="block text-center py-4 flex justify-start items-center">
                  <input
                    ...
                    className="form-radio h-5 w-5 text-blue-600 inline-block ml-3"
                  />
                  <span className="text-lg align-middle w-full">$500-599 / Month</span>
                </label>
              </div>
              ...
              <div className="bg-white shadow-md rounded mb-4 w-full sm:w-full lg:w-3/5">
                <label className="block text-center py-4 flex justify-start items-center">
                  <input
                    ...
                    className="form-radio h-5 w-5 text-blue-600 inline-block ml-3"
                  />
                  <span className="text-lg align-middle w-full">$600+ / Month</span>
                </label>
              </div>
            </div>
