  ...
  return (
    <div className="bg-[#ff7f50]">
      ...
      <div className="container mx-auto px-6 py-20 text-center text-white">
        ...
        <p className="mb-8">Get pre-approved for a new car today!.</p>
        <div className="flex justify-center space-x-4">
          <button className="mt-8 inline-block rounded border-black bg-neutral-50 px-12 py-3 text-sm font-medium text-black transition hover:bg-[#e5e5e5] focus:outline-none focus:ring focus:ring-yellow-400">
            Get Pre-Approved
          </button>
        </div>
      </div>
      ...
      >
        <div className="container mx-auto px-24 flex justify-between">
          <div>
            ...
            <button className="mt-8 inline-block rounded border border-[#ff7f50] bg-[#ff7f50] px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-[#ff7f50] focus:outline-none focus:ring active:text-indigo-500">
              Get Pre-Approved
            </button>
          </div>
          <div class="flex justify-center">
          ...
          <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
            ...
            <div className="relative flex items-center bg-gray-100">
              ...
              <div className="p-8 sm:p-16 lg:p-24">
                ...
                <a
                  href="#"
                  className="mt-8 inline-block rounded border border-[#ff7f50] bg-[#ff7f50] px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-[#ff7f50] focus:outline-none focus:ring active:text-indigo-500"
                >
                  Get in Touch
                </a>
              </div>
        ...
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              ...
              <a
                href="#"
                className="mt-8 inline-block rounded border-black bg-neutral-50 px-12 py-3 text-sm font-medium text-black transition hover:bg-[#e5e5e5] focus:outline-none focus:ring focus:ring-yellow-400"
              >
                Get Started Today
              </a>
            </div>
